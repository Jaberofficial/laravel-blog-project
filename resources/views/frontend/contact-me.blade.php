                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Get in Touch</h1>
                            <span class="subheading">Have a question, feedback, or collaboration idea? I'd love to hear from you.</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="my-5">
                            <form action="{{ url('/store-contact-message') }}" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback" name:required>A name is required.</div>
                                </div>
                                <div class="form-floating">
